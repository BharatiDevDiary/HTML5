...
- It defines the **structure** of web content using elements and tags.
...
- Right-click → **Open With** → choose a web browser (e.g., Chrome, Edge, Firefox).
...
## 5. Installing the Tools We Need
...
- **VS Code** (Visual Studio Code) → A powerful code editor.
